        ...
        <div className="max-w-7xl mx-auto px-6 py-12 space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <Card className="border-border/40 bg-card/40 backdrop-blur-sm p-6 space-y-2">
              ...
              <p className="text-3xl font-light">{activeJobs.length}</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div className="space-y-4">
                    {activeJobs.map((job) => (
                      ...
                      >
                        ...
                        {job.salary_range && <p className="text-sm mb-3">{job.salary_range}</p>}
            ...
            <div className="space-y-6">
              ...
              <Card className="border-border/40 bg-card/40 backdrop-blur-sm p-6 space-y-3">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex gap-2">
                    ...
                    <span className="text-muted-foreground">Candidate matching next</span>
                  </div>
                </div>
              </Card>
              ...
              <Card className="border-accent/40 bg-accent/5 backdrop-blur-sm p-6 space-y-4">
                <div>
                  <h3 className="text-sm font-medium">Support Request</h3>
                  <p className="text-sm text-muted-foreground mt-1">
                ...
                {requests.length > 0 ? (
                  <div className="space-y-2">
                    <p className="text-sm">
                      Latest Status:{' '}
                      <span className="text-accent">{requests[0].status}</span>
                    </p>
